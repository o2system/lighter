...
use O2System\Reactor\Containers\Modules\DataStructures\Module as FrameworkModuleDataStructure;
...
class Router extends KernelRouter
{
        ...
        if ($numOfUriSegments = $this->uri->segments->count()) {
            ...
            for ($i = 0; $i <= $numOfUriSegments; $i++) {
                ...
                foreach ($modules as $module) {
                    ...
                    if ($module->getNamespace() === 'O2System\Reactor\\') {
                        $controllerNamespace = 'O2System\Reactor\Http\Controllers\\';
                    }
     ...
     *
     * @param \O2System\Reactor\Containers\Modules\DataStructures\Module $app
     */
    ...
    final protected function getPagesControllerClassName()
    {
        ...
        foreach ($modules as $module) {
            ...
            if ($module->getNamespace() === 'O2System\Reactor\\') {
                $controllerClassName = 'O2System\Reactor\Http\Controllers\Pages';
            }
        ...
        if (class_exists('O2System\Reactor\Http\Controllers\Pages')) {
            return 'O2System\Reactor\Http\Controllers\Pages';
        }
