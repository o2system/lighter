...
if ( ! function_exists('heading')) {
    ...
    {
        return (new \O2System\Reactor\Libraries\Ui\Contents\Heading($textContent, $level, $attributes))->render();
    }
}
...
if ( ! function_exists('ul')) {
    ...
    {
        return (new \O2System\Reactor\Libraries\Ui\Contents\Lists\Unordered($attributes))->createLists($list)->render();
    }
}
...
if ( ! function_exists('ol')) {
    ...
    {
        return (new \O2System\Reactor\Libraries\Ui\Contents\Lists\Ordered($attributes))->createLists($list)->render();
    }
}
...
if ( ! function_exists('img')) {
    ...
    {
        $img = new \O2System\Reactor\Libraries\Ui\Contents\Image($src, $alt);
